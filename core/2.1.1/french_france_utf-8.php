...
$LANG01 = array(
    ...
    34 => 'Allo Houston... On a un problème',
    35 => 'Se déconnecter',
    36 => 'Le',
...
$LANG03 = array(
    ...
    16 => 'Titre',
    17 => 'Allo Houston... On a un problème',
    18 => 'Remarques',
    ...
    37 => 'Nouveau commentaire en réponse',
...
$LANG04 = array(
    ...
    15 => "Votre compte, sur le site {$_CONF['site_name']}, a ete cree avec succes. Merci d'utiliser les informations ci-dessous pour vous connecter et de sauvegarder ce message pour vous y referer ulterieurement si besoin.",
    ...
    21 => 'Allo Houston... On a un problème',
    22 => 'Devenir membre du site',
    23 => 'Après avoir créé votre compte vous pourrez utilisez toutes les fonctions réservées aux membres.<br/>✉️ Votre adresse email ne sera jamais publiée sur ce site ni cédée à un tiers.',
    24 => 'Un mot de passe vous permettant de vous identifer vous sera envoyé par email à l\'adresse saisie ci-dessus. Par la suite, vous pourrez si besoin modifier ce mot de passe ainsi que votre adresse email.',
    25 => 'Avez-vous oublié votre mot de passe?',
    26 => 'Saisissez <em>soit</em> votre nom d\'utilisateur <em>soit</em> l\'adresse email enregistrée à ce compte, et cliquez sur &laquo;Changement du mot de passe&raquo;. Des instructions à suivre concernant l\'enregistrement d\'un nouveau mot de passe vous seront adressées par email.',
    27 => 'Enregistrez-vous maintenant !',
    28 => 'Changement du mot de passe',
    29 => 'déconnecté de',
    30 => 'connecté à',
    ...
    65 => 'Merci de vous identifier pour accéder à cet espace',
    ...
    89 => "Pour refuser d'entreprendre cette action, vous n'avez simplement qu'a ignorer ce message, ainsi votre mot de passe demeurera inchangé.\n\n",
    90 => 'Vous pouvez choisir un nouveau mot de passe pour le compte ci-dessous. Merci de noter que l\'ancien mot de passe demeurera actif jusqu\'à ce que vous soumettiez ce formulaire.',
    ...
    105 => 'Affichez ma présence dans le bloc &laquo;En ligne&raquo;',
    106 => 'Localisation',
    107 => 'Affiché dans votre profil',
    108 => 'Confirmez le mot de passe',
    ...
    143 => 'Filtrez le contenu des blocs',
    144 => 'Cacher ou montrer des blocs',
    ...
    'user_login' => 'Page réservée à la connexion à l\'espace membres',
    'user_login_message' => 'Merci de vous identifier ci-dessous. Vous devez saisir votre nom d\'utilisateur et votre mot de passe.',
...
$LANG08 = array(
    ...
    18 => 'Le nom du destinataire* ',
    19 => 'Son adresse email* ',
    20 => 'Votre nom* ',
    21 => 'Votre Adresse email* ',
    ...
    25 => 'Vous devez être connecté pour utiliser cette fonction. Votre identification permettra de contrôler tout abus du système',
    26 => 'Ce formulaire vous permet d\'envoyer un message.',
    27 => 'Votre message* ',
    28 => '%s a écrit: ',
    ...
    34 => 'Si vous ne souhaitez plus recevoir de message, merci de bien vouloir modifier les paramètres correspondants dans votre espace membre sur le site. Vous pourrez y choisir les rubriques pour lesquelles vous souhaitez ne plus être informé, ainsi qu\'autoriser ou non les autres membres et l\'administrateur à vous contacter. Cordialement, l\'administrateur du site.',
    35 => 'Désolé, ce membre ne désire pas recevoir de messages.',
    36 => 'Copie :',
    37 => 'Envoyez moi un double de ce message',
    38 => "Ceci est une copie du message que vous avez envoyé à %s du site <{$_CONF['site_url']}> :",
    39 => 'Votre dernier message a été expédié il y a ',
    40 => " secondes.  Pour des raisons de sécurité, ce site nécessite au moins {$_CONF['speedlimit']} secondes enre chaque envoi de message.",
...
$LANG09 = array(
    ...
    42 => 'Merci d\'utiliser une date exprimée comme suit: AAAA-MM-JJ (année-mois-jour).',
    43 => 'Phrase exacte',
    44 => 'Tous ces mots',
...
$LANG21 = array(
    ...
    29 => 'Bloc fonction',
    30 => 'Si vous voulez que l\'un de vos blocs utilise du PHP, saisissez le nom de la fonction à utiliser.  Le nom de la fonction doit commencer par \'phpbloc_\' (ex: phpbloc_getweather).  Si ce n\'est pas le cas, votre fonction NE SERA PAS appellée, ceci pour des raisons de sécurité.  Ne mettez pas de parenthèses vides \'()\' après le nom de votre fonction.  Enfin, nous vous recommandons de mettre tout le code des bloc PHP dans /path/to/geeklog/system/lib-custom.php.  Cela permettera de garder votre code même après une mise à jour du système.',
    ...
    37 => 'Nom erroné dans la fonction du bloc PHP',
    38 => 'Les fonctions des blocs PHP doivent commencer par "phpbloc_" (ex: phpbloc_getweather).  Le préfixe "phpbloc_" est nécessaire pour des raisons de sécurité qui empche l\'exécution de code arbitraire.',
    39 => 'Côté',
    40 => 'Gauche',
    41 => 'Droit',
...
$LANG28 = array(
    ...
    22 => 'Allo Houston... On a un problème',
    23 => 'Ajout par lot',
    24 => 'Importation par lot d\'utilisateurs',
    25 => 'Vous pouvez importer un lot d\'utilisateur dans le système.  Les champ du fichier d\'import doivent être séparés par une tabulation. Ils doivent apparaître dans l\'ordre suivant: Nom complet, nom de connexion, adresse email.  Chaque utilisateur importé sera averti par email et aura un mot de passe auto-généré.  Il ne doit y avoir qu\'un seul utilisateur par ligne.  Ne pas respecter ces consignes peut entraîner des dégat qui ne seront réparables que manuellement, alors redoublez de vigilance!',
    26 => '',
    27 => '',
    ...
    49 => 'Groupe Admin',
    50 => 'Cochez pour permettre de filtrer ce groupe comme groupe administratif',
    51 => 'Jours en ligne',
    ...
    'autotag_desc_user' => '[user: id Titre alternatif] - Affiche un lien vers le profil d\'un utilisateur en utilisant le nom de l\'utilisateur comme titre. Optionellement, un titre alternatif peut être spécifier.'
);
...
$LANG31 = array(
    ...
    8 => 'Admin',
    9 => 'Options',
    10 => 'HTML. Cocher cette case si votre message comporte du code html.',
    11 => 'Message urgent! Cocher cette case pour indiquer au destinataire que ce message est urgent. N\'est pas pris en compte par tous les services de courrier électronique.',
    12 => 'Envoyer',
    13 => 'Effacer',
    14 => 'Ignorer les préférences des membres. En tant qu\'administrateur vous pouvez passer outre les préférences des membres en cochant cette case et leur expédier un message. A utiliser avec modération.',
...
$LANG32 = array(
    ...
    44 => 'Déplacer un plugin vers le début',
    45 => 'Déplacer un plugin vers la fin',
    ...
    56 => 'Mauvaise version',
    57 => 'Inconnu',
    58 => 'L\'ordre de lancement des plugins a été modifié afin de résoudre des dépendences.',
    59 => 'Info',
    60 => 'Fermer',
    61 => 'Status',
    ...
    65 => 'La fonction upload de plugin a été désactivée à cause des erreurs suivantes :',
    66 => 'L\'upload de fichier est désactivé dans votre configuration PHP.',
    67 => 'Le dossier "%s" n\'est pas accessible en écriture.',
    68 => 'Vous n\'avez pas la permission d\'installer des plugins.',
    69 => 'Vous n\'avez pas la permission d\'uploader les plugins.',
...
$MESSAGE = array(
    1 => "Votre inscription a bien été prise en compte. Votre mot de passe vous a été envoyé par email et il devrait vous parvenir sous peu. Merci de suivre les instructions incluses dans ce courriel qui vous permettront de vous connecter à l'espace membre du site {$_CONF['site_name']}",
    ...
    25 => '',
    26 => '',
    27 => 'Votre message a bien été envoyé avec succès.',
    ...
    51 => 'Ce nom de membre existe déjà. Merci d\'en choisir un nouveau.',
    52 => 'L\'email fourni ne paraît pas être valide.',
    53 => 'Votre nouveau mot de passe à été accepté. Merci de l\'inscrire ci-dessous pour accéder au site.',
    54 => 'Votre requête pour l\'obtention d\'un nouveau mot de passe est expirée. Merci d\'essayer de nouveau ci-dessous.',
    ...
    60 => 'La mise à jour de ce plugin a été réalisée avec succès.',
    ...
    71 => 'Votre compte est en attente d\'activation, il doit être approuvé par un admistrateur.',
    ...
    75 => 'Les Trackbacks doivent être envoyés suivant une requte POST.',
    76 => 'Désirez-vous vraiment effacer cet article ?',
    77 => 'ATTENTION:<br' . XHTML . '>Vous avez choisi UTF-8 comme encodage par défaut, malgré le fait que vos serveurs ne supportent pas un encodage multi-bit. Merci d\'installer les fonctions mbstring pour PHP ou choisissez une langue différente.',
    78 => 'Merci de vous assurer que l\'adresse email et l\'email de confirmation soient identiques.',
    ...
    92 => "Merci de <a href=\"{$_CONF['site_admin_url']}/sectest.php\">vérifier la sécurité de votre site</a> avant de l'utiliser.",
    ...
    110 => 'Impossible d\'obtenir l\'URL pour une authentification.',
    111 => 'Erreur d\'authentication.',
    112 => 'La certification à été annulée.',
    113 => 'Votre compte a été créé avec succès. {site_url}',
    114 => 'La re-synchronisation avec votre compte distant a échouée mais votre les informations de votre compte ont bien été sauvegardées.',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "vous ne pouvez pas lire cet article. Peut-être que vous n'êtes pas membre du site {$_CONF['site_name']}.  Vous pouvez <a href=\"{$_CONF['site_url']}/users.php?mode=new\">vous enregistrer</a> sur {$_CONF['site_name']} pour obtenir un compte membre!",
    ...
    'canteditgroup' => 'Vous devez être un membre de ce groupe pour l\'éditer.',
...
$LANG_CONFIG = array(
    ...
    'search_configuration_label' => 'Paramètres de configuration',
...
$LANG_confignames['Core'] = array(
    ...
    'hideprintericon' => 'Masquer le lien ou l\'icon Imprimer',
    ...
    'article_comment_close_days' => 'Nombre de jours pour clore les commentaires (par défaut)',
...
$LANG_VALIDATION = array(
    ...
    'alphaNumeric' => 'Ce champ doit une valeur alpha-numérique',
    'between' => 'Ce champ doit être compris entre les valeurs proposées',
    ...
    'decimal' => 'Ce champ doit être décimale',
    'email' => 'Ce champ doit contenir une adresse email valide',
    'equalTo' => 'Ce champ n\'est pas égale',
    'extension' => 'Ce champ accepte seulement les exensions permises',
    'ip' => 'Ce champ doit être au format IP valide',
    ...
    'range' => 'Ce champ doit être compris entre les valeurs proposées',
    'url' => 'Ce champ doit contenir une URL valide',
    'inList' => 'Ce champ doit contenir une liste spécifique',
    'mail_settings_backend' => 'Ce champ doit contenir \'smtp\', \'sendmail\', ou \'mail\'',
    'mail_settings_sendmail_path' => 'Ce champ doit contenir le chemin valide vers le binaire sendmail',
    'mail_settings_host' => 'Ce champ doit contenir un hostname valide',
    'mail_settings_port' => 'Ce champ doit contenir une valeur comprise entre  0 et 65535',
    'rdf_limit' => 'Ce champ doit être de type horaire comme 24h',
    'path' => 'Le chemin n\'existe pas',
    'file' => 'Le fichier n\'existe pas',
    'fileName' => 'This field must be a proper file name',
    'search_limits' => 'Ce champ doit être numérique séparé par une virgule',
    'num_search_results' => 'Ce champ doit être numérique et inclus dans \'search_limits\' ci dessus',
    'theme' => 'Le dossier du thème n\'existe pas',
